    ...
    <div class="container">
        ...
        <table style="border-collapse: collapse; width:100% color:black; font-family: Arial, sans-serif;">
            <tr>
                ...
                <th style="text-align:center; min-width:100px; max-width:200px; border: 1px solid black; padding: 8px; background-color: #f2f2f2;">Tgl Jatuh Tempo</th>
            ...
            <tr  style="background-color: {{$sim->warna}}; ">
                ...
                <td style="min-width:100px; max-width:200px; border: 1px solid black; color:black; padding: 8px;" >{{$sim->tglstr}}</td>
                <td style="min-width: 80px; border: 1px solid black; color:black; padding: 8px;" >{{$sim->jenis}}</td>
            </tr>
            @endforeach
        </table>
