...
class CreatePenerimaanstokheaderTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('penerimaanstokheader', function (Blueprint $table) {
            ...
            $table->integer('statusapprovalpindahgudangspk')->Length(11)->nullable();
            $table->string('userapprovalpindahgudangspk', 50)->nullable();
            $table->date('tglapprovalpindahgudangspk')->nullable();
