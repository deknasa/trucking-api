...
class CreateSaldogajisupirheaderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saldogajisupirheader', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('saldogajisupirheader');
    }
}
