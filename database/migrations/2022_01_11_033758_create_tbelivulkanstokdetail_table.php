...
class CreateTbelivulkanstokdetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbelivulkanstokdetail', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('belivulkanstok_id')->references('id')->on('tbelivulkanstokheader')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('tbelivulkanstokdetail');
    }
}
