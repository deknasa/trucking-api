...
class CreateTarifdiscounthargaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tarifdiscountharga', function (Blueprint $table) {
            ...
            $table->foreign('tarif_id', 'tarif_tarifdiscountharga_tarif_id_foreign')->references('id')->on('tarif')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('tarifdiscountharga');
    }
}
