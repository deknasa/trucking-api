...
class CreateSaldogajisupirsuratpengantarTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saldogajisupirsuratpengantar', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('saldogajisupirsuratpengantar');
    }
}
