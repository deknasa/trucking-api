...
class AlatBayarSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        AlatBAyar::create(['kodealatbayar' => 'TRANSFER', 'namaalatbayar' => 'TRANSFER', 'keterangan' => 'TRANSFER', 'statuslangsungcair' => '56', 'statusdefault' => '59', 'statusaktif' => '1', 'bank_id' => '2', 'modifiedby' => 'ADMIN', 'coa' => '01.02.02.01',]);
