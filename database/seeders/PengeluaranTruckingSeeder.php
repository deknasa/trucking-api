...
class PengeluaranTruckingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        pengeluarantrucking::create(['kodepengeluaran' => 'BLL', 'keterangan' => 'BIAYA LAPANGAN LEMBUR', 'coadebet' => '01.08.01.06', 'coakredit' => '01.01.01.02', 'coapostingdebet' => '01.08.01.06', 'coapostingkredit' => '01.01.01.02', 'format' => '441', 'modifiedby' => 'ADMIN',]);
