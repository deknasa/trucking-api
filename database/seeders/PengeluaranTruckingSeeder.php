...
class PengeluaranTruckingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        pengeluarantrucking::create(['kodepengeluaran' => 'BST', 'keterangan' => 'SUMBANGAN SOSIAL', 'coadebet' => '07.02.01.33', 'coakredit' => '01.01.01.02', 'coapostingdebet' => '07.02.01.33', 'coapostingkredit' => '01.01.01.02', 'format' => '258', 'modifiedby' => 'ADMIN',]);
