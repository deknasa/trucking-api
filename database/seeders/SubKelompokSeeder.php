...
class SubKelompokSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Subkelompok::create(['kodesubkelompok' => 'SPAREPART', 'keterangan' => 'SPAREPART', 'kelompok_id' => '2', 'statusaktif' => '1', 'modifiedby' => 'ADMIN',]);
        Subkelompok::create(['kodesubkelompok' => 'BAN', 'keterangan' => 'BAN', 'kelompok_id' => '1', 'statusaktif' => '1', 'modifiedby' => 'ADMIN',]);
    }
}
