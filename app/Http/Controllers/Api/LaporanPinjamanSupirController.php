...
class LaporanPinjamanSupirController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $laporanpinjamansupir = new LaporanPinjamanSupir();
        $laporan_pinjamansupir = $laporanpinjamansupir->getReport($sampai, $jenis);

        // return response([
        //     'data' => $export
        // ]);

        $data = json_decode($laporan_pinjamansupir);
        ...
        $sheet->setCellValue('A3', 'Periode: ' . date('d-M-Y', strtotime($sampai)));
