    ...
    public function store(StoreProsesUangJalanSupirHeaderRequest $request): JsonResponse
    {
        ...
        try {
            ...
            if ($request->button == 'btnSubmit') {
                ...
                $prosesUangJalanSupir->tgldariheader = date('Y-m-d', strtotime(request()->tgldariheader));
                $prosesUangJalanSupir->tglsampaiheader = date('Y-m-d', strtotime(request()->tglsampaiheader));
            }
