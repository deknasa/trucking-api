...
class PengeluaranStokDetailFifoController extends Controller
{
    ...
    public function store(StorePengeluaranStokDetailFifoRequest $request)
    {
        ...
        try {
            ...
            $datalist = DB::table($temphasil2)->get();


            $datadetail = json_decode($datalist, true);
            ...
            foreach ($datadetail as $item) {
                ...
                $pengeluaranstokdetailfifo->pengeluaranstokheader_id = $request->pengeluaranstokheader_id;
                $pengeluaranstokdetailfifo->nobukti = $request->nobukti;
                $pengeluaranstokdetailfifo->stok_id = $request->stok_id;
                $pengeluaranstokdetailfifo->gudang_id = $request->gudang_id;
                $pengeluaranstokdetailfifo->urut = $item['urut'];
                $pengeluaranstokdetailfifo->qty = $item['qty'];
                $pengeluaranstokdetailfifo->penerimaanstokheader_nobukti = $item['penerimaan_nobukti'];
                $pengeluaranstokdetailfifo->penerimaanstok_qty = $item['penerimaan_nobukti'];
                $pengeluaranstokdetailfifo->qty = $item['qty'];
                $pengeluaranstokdetailfifo->modifiedby = $item['modifiedby'];
