...
class LaporanRitasiGandenganController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $laporanritasigandengan = new LaporanRitasiGandengan();
        $laporan_ritasigandengan = $laporanritasigandengan->Export($periode);
        ...
        $ritasi = $laporan_ritasigandengan;
        $judul = $getJudul->text;
        $namacabang = 'CABANG ' . $getCabang->namacabang;
        ...
        $totalTanggal = count((array)$ritasi[0]) - 1;
