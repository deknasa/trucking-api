...
class HistoriPengeluaranStokController extends Controller
{
    ...
    public function report(Request $request)
    {
        ...
        $historipengeluaranstok = $HistoriPengeluaranStok->get();
        $dataHeader = $report;
        ...
        if ($request->export == true) {
            ...
            $sheet->setCellValue('A1', $historipengeluaranstok[0]->judul);
            $sheet->getStyle("A1")->getFont()->setSize(11);
            $sheet->getStyle('A1')->getAlignment()->setHorizontal('center');
            $sheet->mergeCells('A1:H1');
            $sheet->getStyle("A1")->getFont()->setBold(true);
            $sheet->getStyle("A2")->getFont()->setBold(true);
            $sheet->setCellValue('A2', $historipengeluaranstok[0]->judulLaporan);
            ...
            // LOOPING DETAIL
            foreach ($historipengeluaranstok as $response_index => $response_detail) {
                ...
                $sheet->setCellValue("G$detail_start_row", $response_detail->nilaikeluar);
            ...
            $filename = 'Histori Pengeluaran Stok  ' . date('dmYHis');
