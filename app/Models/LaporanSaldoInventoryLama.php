...
class LaporanSaldoInventoryLama extends MyModel
{
    use HasFactory;
    ...
    public function getReport($kelompok_id, $statusreuse, $statusban, $filter, $jenistgltampil, $priode, $stokdari_id, $stoksampai_id, $dataFilter, $prosesneraca)
    {
        ...
        DB::table($temprekapall)->insertUsing([
            ...
            'iddata',
            'tglinput',
        ], (new KartuStokLama())->getlaporan($priode, $priode, $stokdari_id, $stoksampai_id, $gudang_id, $trado_id, $gandengan_id, $filterdata));
        ...
        $querymaxin = db::table($temprekapall)->from(db::raw($temprekapall . " a"))
            ...
            ->join(DB::raw("kartustoklama as e"), function ($join) {
        ...
        $query = DB::table($temprekapall)->from(
            ...
            ->select(
                DB::raw("upper('Laporan Saldo Inventory Lama') as header"),
