...
class Pelanggan extends MyModel
{
    ...
    public function createTemp(string $modelTable)
    {
        ...
        Schema::create($temp, function ($table) {
            ...
            $table->string('alamatfakturpajak',255)->nullable();
            $table->string('alamatkantorpenagihan',255)->nullable();
            $table->string('namapemilik',255)->nullable();
            $table->string('telpkantor',255)->nullable();
            $table->string('faxkantor',255)->nullable();
            $table->string('website',255)->nullable();
            $table->string('contactperson',255)->nullable();
            $table->string('telpcp',255)->nullable();
            ...
            $table->string('prosedurpenagihan',255)->nullable();
            $table->string('syaratpenagihan',255)->nullable();
            $table->string('pickeuangan',255)->nullable();
            $table->string('telppickeuangan',50)->nullable();
            $table->string('jenisusaha',255)->nullable();
            $table->string('volumeperbulan',255)->nullable();
            $table->string('kompetitor',255)->nullable();
            $table->string('referensi',255)->nullable();
            $table->double('nominalplafon', 15,2)->nullable();
            $table->string('danaditransferdari',255)->nullable();
            $table->string('atasnama',255)->nullable();
            $table->string('norekening',255)->nullable();
