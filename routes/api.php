        ...
        $response = [
            "data" => [
                [
                    ...
                    "subgrp" => "ABSENSI",
                    "text" => "#ABS # 9999#\/#R#\/#Y",
                    "memo" => "UNTUK PENOMORAN ABSENSI",
                    "created_at" => "2022-01-28 16=>06=>59.790",
                    "updated_at" => "2022-03-02 10=>21=>44.963",
                    "modifiedby" => "ADMIN"
                ],
                [
                    "id" => "1314",
                    "grp" => "ADE CHELSEA PUSPITA",
                    "subgrp" => "SITI NURAINI M.AK",
                    "text" => "NADINE RAHIMAH",
                    "memo" => "OMAN JAILANI",
                    "created_at" => "2022-08-30 16=>57=>29.640",
                    "updated_at" => "2022-08-30 16=>57=>29.640",
                    "modifiedby" => "ADMIN"
                ],
                [
                    "id" => "1339",
                    "grp" => "AISYAH TAMI WIDIASTUTI",
                    "subgrp" => "LIDYA MICHELLE NURDIYANTI S.PSI",
                    "text" => "AJIMIN KURNIAWAN",
                    "memo" => "JAMALIA PURWANTI",
                    "created_at" => "2022-08-30 16=>57=>29.760",
                    "updated_at" => "2022-08-30 16=>57=>29.760",
                    "modifiedby" => "GUEST"
                ],
                [
                    "id" => "1375",
                    "grp" => "ALAMBANA ARDIANTO S.KOM",
                    "subgrp" => "KAREN LAILASARI S.KOM",
                    "text" => "VICKY PUDJIASTUTI",
                    "memo" => "BANAWI SINAGA",
                    "created_at" => "2022-08-30 16=>57=>29.920",
                    "updated_at" => "2022-08-30 16=>57=>29.920",
                    "modifiedby" => "ADMIN"
                ],
                [
                    "id" => "1331",
                    "grp" => "ALMIRA NURAINI",
                    "subgrp" => "JASMIN MARDHIYAH",
                    "text" => "PRABA HARSANA WAHYUDIN",
                    "memo" => "ZAENAB TANIA NOVITASARI M.TI.",
                    "created_at" => "2022-08-30 16=>57=>29.733",
                    "updated_at" => "2022-08-30 16=>57=>29.733",
                    "modifiedby" => "ADMIN"
                ],
                [
                    "id" => "1347",
                    "grp" => "ANA MAYASARI",
                    "subgrp" => "PUSPA LESTARI",
                    "text" => "DIPA KARSANA HUTAPEA",
                    "memo" => "IRFAN NASHIRUDDIN",
                    "created_at" => "2022-08-30 16=>57=>29.827",
                    "updated_at" => "2022-08-30 16=>57=>29.827",
                    "modifiedby" => "GUEST"
                ],
                [
                    "id" => "1297",
                    "grp" => "ANIM EX DOLOR TOTAM",
                    "subgrp" => "BLANDITIIS SIT REPR",
                    "text" => "PROVIDENT SEQUI OPT",
                    "memo" => "IPSUM FUGIAT ATQUE",
                    "created_at" => "2022-07-27 13=>29=>00.793",
                    "updated_at" => "2022-07-27 13=>29=>00.793",
                    "modifiedby" => "TEST"
                ],
                [
                    "id" => "1345",
                    "grp" => "ANITA KUSWANDARI",
                    "subgrp" => "SARAH PUDJIASTUTI S.H.",
                    "text" => "EKO SAPUTRA",
                    "memo" => "NABILA USAMAH S.PSI",
                    "created_at" => "2022-08-30 16=>57=>29.807",
                    "updated_at" => "2022-08-30 16=>57=>29.807",
                    "modifiedby" => "GUEST"
                ],
                [
                    "id" => "1332",
                    "grp" => "ATMA MEGANTARA",
                    "subgrp" => "TALIA MANDASARI",
                    "text" => "ANA AURORA FARIDA",
                    "memo" => "PARIS SISKA YUNIAR M.AK",
                    "created_at" => "2022-08-30 16=>57=>29.737",
                    "updated_at" => "2022-08-30 16=>57=>29.737",
                    "modifiedby" => "ADMIN"
                ],
                [
                    "id" => "1382",
                    "grp" => "BAGAS SURYONO M.TI.",
                    "subgrp" => "MAIDA HANDAYANI",
                    "text" => "SEPTI WIRDA NOVITASARI M.KOM.",
                    "memo" => "GARAN MUSTOFA",
                    "created_at" => "2022-08-30 16=>57=>29.933",
                    "updated_at" => "2022-08-30 16=>57=>29.933",
                    "modifiedby" => "GUEST"
                ]
            ],
            "attributes" => [
