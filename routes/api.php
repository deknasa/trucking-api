...
route::middleware(['auth:api'])->group(function () {
    ...
    Route::post('jobemkl/nominalprediksi', [JobEmklController::class, 'nominalprediksi']);
    ...
    Route::post('mandor/approvalaktif', [MandorController::class, 'approvalaktif']);
    Route::post('container/approvalnonaktif', [ContainerController::class, 'approvalnonaktif']);
    Route::post('container/approvalaktif', [ContainerController::class, 'approvalaktif']);
    Route::post('triptangki/approvalnonaktif', [TripTangkiController::class, 'approvalnonaktif']);
    Route::post('triptangki/approvalaktif', [TripTangkiController::class, 'approvalaktif']);
    ...
    Route::post('statuscontainer/approvalaktif', [StatusContainerController::class, 'approvalaktif']);
    ...
    Route::post('upahritasi/approvalaktif', [UpahRitasiController::class, 'approvalaktif']);
    ...
    Route::post('pengeluarantrucking/approvalaktif', [PengeluaranTruckingController::class, 'approvalaktif']);
    Route::post('penerimaantrucking/approvalnonaktif', [PenerimaanTruckingController::class, 'approvalnonaktif']);
    Route::post('penerimaantrucking/approvalaktif', [PenerimaanTruckingController::class, 'approvalaktif']);
    ...
    Route::post('tariftangki/approvalaktif', [TarifTangkiController::class, 'approvalaktif']);
    ...
    Route::post('upahsupirtangki/approvalaktif', [UpahSupirTangkiController::class, 'approvalaktif']);
    ...
    Route::post('customer/approvalaktif', [CustomerController::class, 'approvalaktif']);
    Route::post('gandengan/approvalnonaktif', [GandenganController::class, 'approvalnonaktif']);
    Route::post('gandengan/approvalaktif', [GandenganController::class, 'approvalaktif']);
    ...
    Route::post('supplier/approvalaktif', [SupplierController::class, 'approvalaktif']);
    Route::post('shipper/approvalnonaktif', [ShipperController::class, 'approvalnonaktif']);
    Route::post('shipper/approvalaktif', [ShipperController::class, 'approvalaktif']);
    ...
    Route::post('gudang/approvalaktif', [GudangController::class, 'approvalaktif']);
    Route::post('kategori/approvalnonaktif', [KategoriController::class, 'approvalnonaktif']);
    Route::post('kategori/approvalaktif', [KategoriController::class, 'approvalaktif']);
    Route::post('kelompok/approvalnonaktif', [KelompokController::class, 'approvalnonaktif']);
    Route::post('kelompok/approvalaktif', [KelompokController::class, 'approvalaktif']);
    Route::post('merk/approvalnonaktif', [MerkController::class, 'approvalnonaktif']);
    Route::post('merk/approvalaktif', [MerkController::class, 'approvalaktif']);
    Route::post('satuan/approvalnonaktif', [SatuanController::class, 'approvalnonaktif']);
    Route::post('satuan/approvalaktif', [SatuanController::class, 'approvalaktif']);
    Route::post('subkelompok/approvalnonaktif', [SubKelompokController::class, 'approvalnonaktif']);
    Route::post('subkelompok/approvalaktif', [SubKelompokController::class, 'approvalaktif']);
    ...
    Route::post('penerimaanstok/approvalaktif', [PenerimaanStokController::class, 'approvalaktif']);
    Route::post('pengeluaranstok/approvalnonaktif', [PengeluaranStokController::class, 'approvalnonaktif']);
    Route::post('pengeluaranstok/approvalaktif', [PengeluaranStokController::class, 'approvalaktif']);
    ...
    Route::post('akuntansi/approvalaktif', [AkuntansiController::class, 'approvalaktif']);
    Route::post('typeakuntansi/approvalnonaktif', [TypeAkuntansiController::class, 'approvalnonaktif']);
    Route::post('typeakuntansi/approvalaktif', [TypeAkuntansiController::class, 'approvalaktif']);
    Route::post('maintypeakuntansi/approvalnonaktif', [MainTypeAkuntansiController::class, 'approvalnonaktif']);
    Route::post('maintypeakuntansi/approvalaktif', [MainTypeAkuntansiController::class, 'approvalaktif']);
    Route::post('mainakunpusat/approvalnonaktif', [MainAkunPusatController::class, 'approvalnonaktif']);
    Route::post('mainakunpusat/approvalaktif', [MainAkunPusatController::class, 'approvalaktif']);
    Route::post('akunpusat/approvalnonaktif', [AkunPusatController::class, 'approvalnonaktif']);
    Route::post('akunpusat/approvalaktif', [AkunPusatController::class, 'approvalaktif']);
    Route::post('alatbayar/approvalnonaktif', [AlatBayarController::class, 'approvalnonaktif']);
    Route::post('alatbayar/approvalaktif', [AlatBayarController::class, 'approvalaktif']);
    Route::post('bank/approvalnonaktif', [BankController::class, 'approvalnonaktif']);
    Route::post('bank/approvalaktif', [BankController::class, 'approvalaktif']);
    Route::post('bankpelanggan/approvalnonaktif', [BankPelangganController::class, 'approvalnonaktif']);
    Route::post('bankpelanggan/approvalaktif', [BankPelangganController::class, 'approvalaktif']);
    ...
    Route::post('tradotambahanabsensi/approval', [TradoTambahanAbsensiController::class, 'approval']);
...
route::middleware(['auth:api', 'authorized'])->group(function () {
    ...
    Route::post('tradotambahanabsensi/{id}/cekvalidasi', [TradoTambahanAbsensiController::class, 'cekvalidasi'])->whereNumber('id');
    Route::get('tradotambahanabsensi/export', [TradoTambahanAbsensiController::class, 'export'])->whereNumber('id');
    Route::get('tradotambahanabsensi/field_length', [TradoTambahanAbsensiController::class, 'fieldLength']);
    Route::resource('tradotambahanabsensi', TradoTambahanAbsensiController::class)->whereNumber('tradotambahanabsensi');
